...
a persistence unit "SistemaBancarioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "SistemaBancario\pom.xml":
...
artifact ("SistemaBancario.war") is already built. You can build
